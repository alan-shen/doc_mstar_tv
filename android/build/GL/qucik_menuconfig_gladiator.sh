...
function product_env () {
	...
	KERNEL_SOURCE_PATH="${ANDROID_BUILD_TOP}/kernel"
	CROSS_COMPILE_PATH="${ANDROID_BUILD_TOP}/prebuilts/gcc/linux-x86/arm/mstar-arm-tools/arm-2014.05/bin/arm-none-linux-gnueabi-"
	KERNEL_CONFIG_PATH="${KERNEL_SOURCE_PATH}/arch/arm/configs/mstar_928_defconfig"
	KERNEL_DEFCONFIG_NAME="mstar_928_defconfig"
	ARCH_PRODUCT="arm"
}
